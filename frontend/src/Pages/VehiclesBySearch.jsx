...
const VehiclesBySearch = () => {

    const { filteredVehicles, setfilteredVehicles } = useContext(SearchVehContext);
        ...
        useEffect (() => {
          ...
          console.log("Displayed:", displayVehicles);
      ...
      const filtersVeh = (e) => {
          ...
          const filteredVeh = filteredVehicles.filter(vehicle => {
                ...
                <div className='flex w-full gap-4 bg-gray-100 px-2 sm:px-3 md:px-6 lg:px-8 py-2 sm:py-3 md:py-4 lg:py-6 items-center justify-center'>
                    ...
                    <SearchBar />
                        {displayVehicles.length > 0 ? (
                            displayVehicles?.map((item, index) => {
...
export default VehiclesBySearch