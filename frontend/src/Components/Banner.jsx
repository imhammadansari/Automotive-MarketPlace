...
const Banner = () => {
    ...
    <div className='w-full min-h-screen flex flex-col md:flex-row py-4 md:py-6 lg:py-8 px-2 md:px-6 lg:px-8' style={{
      ...
      <div className='w-full text-black h-full items-center flex flex-col gap-4 md:flex-row px-2 md:px-6 lg:px-8 xl:px-10'>
        ...
        <div className='flex flex-col gap-4'>
            {!img1Loaded && (
  <div className="w-[12rem] h-[7rem] lg:h-[14rem] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-pulse rounded-xl shadow-[8px_0_4px_0_rgb(2,6,111)]" />
)}
            <LazyLoadImage
  ...
  <div className="w-[12rem] h-[7rem] lg:h-[14rem] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-pulse rounded-xl shadow-[8px_0_4px_0_rgb(2,6,111)]" />
          ...
          <div>
           {!img3Loaded && (
  <div className="w-[15rem] md:w-[22rem] lg:w-[20rem] h-[15rem] lg:h-[20rem] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-pulse rounded-xl shadow-[8px_0_4px_0_rgb(2,6,111)]" />
)}
            <LazyLoadImage
