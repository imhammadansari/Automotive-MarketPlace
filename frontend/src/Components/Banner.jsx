...
const Banner = () => {
  ...
  return (
    <div
      className='w-full min-h-screen flex flex-col md:flex-row py-4 md:py-6 lg:py-8 px-2 md:px-6 lg:px-8'
      style={{ background: 'linear-gradient(to right, #e8e8ea, #f0f0f1, #ffffff)' }}
    >
      <div className='w-full text-black h-full items-center flex flex-col gap-4 md:flex-row px-2 md:px-6 lg:px-8 xl:px-10'>
        <div className='w-full md:w-1/2 h-full flex flex-col justify-center'>
          ...
          <div className='flex gap-4 mt-4'>
            <button className='py-2 text-xs sm:text-base md:text-sm lg:text-base px-3 bg-[rgb(2,6,111)] hover:text-[rgb(2,6,111)] cursor-pointer hover:bg-[rgb(234,234,236)] text-white rounded-md'>
              Explore Cars
            </button>
            <button className='py-2 text-xs sm:text-base md:text-sm lg:text-base px-3 border-2 text-[rgb(2,6,111)] cursor-pointer border-[rgb(2,6,111)] hover:bg-[rgb(2,6,111)] hover:text-white rounded-md'>
              Sell Your Car
            </button>
          </div>
        </div>
          ...
          <div className='flex flex-col gap-4'>
            {!img1Loaded && (
              <ShimmerPostItem
                ...
                cta
                imageType='thumbnail'
                imageWidth={336} // 21rem
                imageHeight={224} // 14rem
              />
            )}
            <LazyLoadImage
              className={`w-[21rem] rounded-xl shadow-[8px_0_4px_0_rgb(2,6,111)] ${
          ...
          <div>
            {!img3Loaded && (
              <ShimmerPostItem
                ...
                cta
                imageType='thumbnail'
                imageWidth={352} // 22rem
                imageHeight={224}
              />
            )}
            <LazyLoadImage
              className={`w-[22rem] md:w-[22rem] lg:w-[20rem] rounded-xl shadow-[8px_0_4px_0_rgb(2,6,111)] ${
                img3Loaded ? 'block' : 'hidden'
              }`}
